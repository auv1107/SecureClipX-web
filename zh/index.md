...
features:
  ...
  - title: 防御剪贴板攻击
    ...
    icon: 🚫
  - title: 快捷操作栏
    details: 选中文字的上方会显示快速安全复制、粘贴选项，方便快速操作
    icon: 🔐
  - title: 单独的复制快捷键
    details: 可以设定单独的快捷键进行安全复制、安全粘贴
    icon: ⌨️
  - title: 覆盖系统复制粘贴快捷键
    details: 覆盖后所有对文字的 ⌘C，自动从 Copi 的安全渠道进行复制、粘贴
    icon: ✅
---
...
<img src="/images/actionbar2.png" alt="文字的快速操作按钮" width=400 height=400/>

### 2. 快捷键模式
可以设定单独的快捷键进行安全复制、安全粘贴。
<img src="/images/shortcuts.png" alt="可以设定单独的快捷键进行安全复制、安全粘贴" width=400 height=400/>

### 3. 覆盖系统复制粘贴快捷键
覆盖后所有对文字的复制粘贴自动从 Copi 的安全渠道进行复制、粘贴。
<img src="/images/override-shortcuts.png" alt="覆盖后所有对文字的复制粘贴自动从 Copi 的安全渠道进行复制、粘贴" width=400 height=400/>
...
<img src="/images/safecopy.png" alt="如何确保数据安全" width=800 height=400/>
...
我是个全职独立开发者，我喜欢写代码，喜欢做一些工具软件。**Copi** 将是我正式发布的第一款开源的 Mac 软件、第二款免费的 Mac 软件。

目前我的收入完全来自下面这款剪贴板管理软件 **CleanClip**。我经常在 Reddit 上发布它的更新，并且受到了很多朋友的喜欢。

如果你喜欢我的工作，可以通过 [💰 购买软件](https://clip-purchase.macaify.com/) 或 [❤️ 赞助 Copi 开源项目](https://macaify.lemonsqueezy.com/buy/3e207e60-a329-48b9-86fc-e55e37d835d1?logo=0&discount=0) 来支持我。
